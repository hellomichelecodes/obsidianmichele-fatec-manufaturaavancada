...
- # Conteúdos Extras/ Pesquisa:
	- Exercícios de expressões numéricas divididos por nível de dificuldade para você praticar:
		...
		Medianos (Com mais símbolos e operações)
		4. $40 - [15 + (8 - 3) \times 2]$
		5. $2^3 \times 5 - 12 \div 4 + 6$
		6. $50 \div [2 + (3^2 - 1)]$
		
		Difíceis (Com potências, raízes e múltiplos agrupamentos)
		7. $100 - \{ 2 \times [ (15 - 3 \times 2) + 2^4 ] \}$
		8. $\sqrt{36} \times 5 + [ (4^2 - 6) \div 2 ] - 10$
		9. $\{ [ 3 \times (8 - 2^2) + 10 ] \div 11 \} \times 5^2$
		10. $120 \div \{ 2 \times [ 30 - (4^2 + \sqrt{64}) ] \}$
	- Gabarito Resumido
		- **1.** $19$
		- **2.** $13$
		- **3.** $27$
